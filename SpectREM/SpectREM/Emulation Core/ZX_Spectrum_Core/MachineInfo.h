...
static const MachineInfo machines[] = {
    ...
    { 32, 69888, 14335, 224, 12544, 1792, 43008, 128, 4, 56, 8, 256, 192, 448, 312, 32, false, false,  10, 16, 16384, 65536,  -1, false,"ZXSpectrum 48k",     eZXSpectrum48 },
    ...
    { 36, 70908, 14364, 228, 12768, 1596, 43776, 128, 4, 56, 7, 256, 192, 448, 311, 32,  true,  true,  12, 16, 65536, 131072,  1,  true,"ZXSpectrum 128k +2A",eZXSpectrum128_2A }
};
